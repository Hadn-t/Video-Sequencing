...
existing_actions = np.array(['thanks', 'hello', 'iloveyou'])
new_actions = np.array(['yes', 'no', 'please'])  # Add new words here
...
def load_and_update_model():
    ...
    new_output = Dense(actions.shape[0], activation='softmax')(x)
